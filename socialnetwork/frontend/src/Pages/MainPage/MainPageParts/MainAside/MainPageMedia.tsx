...
const MediaHeader =  () =>{
  return(
    <div className="flex justify-between p-4">
          ...
          <div className=" hover:bg-main_d_black rounded-full font-light size-8 border-main_l_grey border-1">
          </div>
        </div>
  )
}
  ...
  return(
    <div className="bg-neutral-800 rounded-lg p-4 text-main_white">
          ...
          <button className="bg-main_white text-main_BLACK rounded-full py-2 px-4 mt-5 border-1 border-main_white
             hover:bg-main_l_black hover:text-main_white hover:border-1 hover:border-main_white">Создать плейлист</button>
    </div>
  )
}
...
const LanguageButton = () =>{
  return(
    <button className="flex p-2 m-4 border-1 border-main_white rounded-full justify-center items-center w-2/6 hover:border-2 hover:underline">
