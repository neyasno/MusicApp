...
export default function LanguageButton() {
    ...
    const changeLanguage = (action:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    return(
    <div>
        <button className="flex p-2 ml-4 border-1 border-main_WHITE rounded-full justify-center items-center w-2/6 hover:border-2 hover:underline"
            onClick={(action)=>{changeLanguage(action)}}>
