...
const SearchField = () => {
  ...
  return(
    <form action="">
      <div className="flex p-3 rounded-full bg-neutral-800 items-center border-2 focus-within:border-white border-neutral-800">
...
export default function MainPageHeader() {
  return (
    <header className="bg-neutral-950 rounded-xl">
      <nav>
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center p-2 mr-5">
            ...
            <button className="bg-white text-black font-bold rounded-full  px-10 py-3 hover:underline ">Войти</button>
          </div>
